...
class ImageSaveParams:
    def __init__(self, image, p, filename, pnginfo):
        ...
        self.p = p
        """p object with processing parameters; either StandardDemoProcessing or an object with same fields"""
...
def on_model_loaded(callback):
    """register a function to be called when the standard demo model is created; the model is
