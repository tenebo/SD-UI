...
def list_models():
    ...
    if shared.cmd_opts.no_download_sd_model or cmd_ckpt != shared.sd_model_file or os.path.exists(cmd_ckpt):
        ...
        model_url = "https://huggingface.co/runwayml/standard-demo-v1-5/resolve/main/v1-5-pruned-emaonly.safetensors"
...
def enable_midas_autodownload():
    ...
    # standard-demo-stability-ai hard-codes the midas model path to
        ...
        if self.sd_model is None:
            with self.lock:
                ...
                try:
                    ...
                    errors.display(e, "loading standard demo model", full_traceback=True)
                    print("", file=sys.stderr)
                    print("Standard demo model failed to load", file=sys.stderr)
                    self.sd_model = None
...
def get_empty_cond(sd_model):
    ...
    p = processing.StandardDemoProcessingTxt2Img()
