...
parser.add_argument('--ckpt',type=str,default=sd_model_file,help='path to checkpoint of standard demo model; if specified, this checkpoint will be added to the list of checkpoints and loaded')
parser.add_argument('--ckpt-dir',type=str,default=_B,help='Path to directory with standard demo checkpoints')
...
parser.add_argument('--allow-code',action=_A,help='allow custom script execution from ourui')
parser.add_argument('--medvram',action=_A,help='enable standard demo model optimizations for sacrificing a little speed for low VRM usage')
parser.add_argument('--medvram-sdxl',action=_A,help='enable --medvram optimization just for SDXL models')
parser.add_argument('--lowvram',action=_A,help='enable standard demo model optimizations for sacrificing a lot of speed for very low VRM usage')
parser.add_argument('--lowram',action=_A,help='load standard demo checkpoint weights to VRAM instead of RAM')
...
parser.add_argument('--hide-ui-dir-config',action=_A,help='hide directory configuration from ourui',default=_C)
...
parser.add_argument('--opt-channelslast',action=_A,help='change memory type for standard demo to channels last')
parser.add_argument('--styles-file',type=str,help='filename to use for styles',default=os.path.join(data_path,'styles.csv'))
parser.add_argument('--autolaunch',action=_A,help="open the ourui URL in the system's default browser upon launch",default=_C)
...
parser.add_argument('--api',action=_A,help='use api=True to launch the API together with the ourui (use --noourui instead for only the API)')
...
parser.add_argument('--noourui',action=_A,help='use api=True to launch the API instead of the ourui')
