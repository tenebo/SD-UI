...
parser.add_argument('--api',action=_A,help='use api=True to launch the API together with the ourui (use --nowebui instead for only the API)')
...
parser.add_argument('--nowebui',action=_A,help='use api=True to launch the API instead of the ourui')
