...
sd_repo_configs_path=os.path.join(paths.paths['Standard Demo'],_B,'standard-demo')
sd_xl_repo_configs_path=os.path.join(paths.paths['Standard Demo XL'],_B,'inference')
