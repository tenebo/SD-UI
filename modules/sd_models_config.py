...
sd_repo_configs_path = os.path.join(paths.paths['Standard Demo'], "configs", "stable-diffusion")
sd_xl_repo_configs_path = os.path.join(paths.paths['Standard Demo XL'], "configs", "inference")
