...
from modules.processing import StandardDemoProcessingTxt2Img,StandardDemoProcessingImg2Img
...
StandardDemoTxt2ImgProcessingAPI=PydanticModelGenerator('StandardDemoProcessingTxt2Img',StandardDemoProcessingTxt2Img,[{_B:_J,_C:str,_D:'Euler'},{_B:_O,_C:str,_D:_A},{_B:_P,_C:list,_D:[]},{_B:_Q,_C:bool,_D:_H},{_B:_R,_C:bool,_D:_E},{_B:_S,_C:dict,_D:{}}]).generate_model()
StandardDemoImg2ImgProcessingAPI=PydanticModelGenerator('StandardDemoProcessingImg2Img',StandardDemoProcessingImg2Img,[{_B:_J,_C:str,_D:'Euler'},{_B:'init_images',_C:list,_D:_A},{_B:'denoising_strength',_C:float,_D:.75},{_B:'mask',_C:str,_D:_A},{_B:'include_init_images',_C:bool,_D:_E,_K:_H},{_B:_O,_C:str,_D:_A},{_B:_P,_C:list,_D:[]},{_B:_Q,_C:bool,_D:_H},{_B:_R,_C:bool,_D:_E},{_B:_S,_C:dict,_D:{}}]).generate_model()
