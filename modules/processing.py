...
class StableDiffusionProcessing:
	...
	def __post_init__(A):
		if A.sampler_index is not _A:print('sampler_index argument for StableDiffusionProcessing does not do anything; use sampler_name',file=sys.stderr)
		A.comments={}
		...
		A.cached_uc=StableDiffusionProcessing.cached_uc;A.cached_c=StableDiffusionProcessing.cached_c
	@property
	...
	def close(A):
		...
		if not opts.persistent_cond_cache:StableDiffusionProcessing.cached_c=[_A,_A];StableDiffusionProcessing.cached_uc=[_A,_A]
...
class StableDiffusionProcessingTxt2Img(StableDiffusionProcessing):
	...
	def __post_init__(A):
		...
		A.cached_hr_uc=StableDiffusionProcessingTxt2Img.cached_hr_uc;A.cached_hr_c=StableDiffusionProcessingTxt2Img.cached_hr_c
	...
	def close(A):
		...
		if not opts.persistent_cond_cache:StableDiffusionProcessingTxt2Img.cached_hr_uc=[_A,_A];StableDiffusionProcessingTxt2Img.cached_hr_c=[_A,_A]
	def setup_prompts(A):
		super().setup_prompts()
