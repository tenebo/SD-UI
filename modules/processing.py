...
class StandardDemoProcessing:
    ...
    def __post_init__(self):
        if self.sampler_index is not None:
            print("sampler_index argument for StandardDemoProcessing does not do anything; use sampler_name", file=sys.stderr)
        ...
        self.cached_uc = StandardDemoProcessing.cached_uc
        self.cached_c = StandardDemoProcessing.cached_c
    ...
    def close(self):
        ...
        if not opts.persistent_cond_cache:
            StandardDemoProcessing.cached_c = [None, None]
            StandardDemoProcessing.cached_uc = [None, None]
...
class Processed:
    def __init__(self, p: StandardDemoProcessing, images_list, seed=-1, info="", subseed=None, all_prompts=None, all_negative_prompts=None, all_seeds=None, all_subseeds=None, index_of_first_image=0, infotexts=None, comments=""):
    ...
    def infotext(self, p: StandardDemoProcessing, index):
...
def process_images(p: StandardDemoProcessing) -> Processed:
...
def process_images_inner(p: StandardDemoProcessing) -> Processed:
...
class StandardDemoProcessingTxt2Img(StandardDemoProcessing):
    ...
    def __post_init__(self):
        ...
        self.cached_hr_uc = StandardDemoProcessingTxt2Img.cached_hr_uc
        self.cached_hr_c = StandardDemoProcessingTxt2Img.cached_hr_c
    ...
    def close(self):
        ...
        self.hr_uc = None
        if not opts.persistent_cond_cache:
            StandardDemoProcessingTxt2Img.cached_hr_uc = [None, None]
            StandardDemoProcessingTxt2Img.cached_hr_c = [None, None]
